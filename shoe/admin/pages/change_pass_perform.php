...
if ($pass_new == '' || $confirm_pass == '') {
    ...
    if ($dem == 0) {
        $_SESSION['thongbaoloi'] = "Sai username";
        echo "
		<script language='javascript'>
        ...
        $sql_check2 = mysqli_query($conn, "select * from tbl_user where username = '$username' and password = '$pass_old'");
		...
		";
            ...
            if ($pass_new != $confirm_pass) {
                ...
                $sql = "UPDATE tbl_user SET password = '$pass_new' WHERE username = '$username'";
