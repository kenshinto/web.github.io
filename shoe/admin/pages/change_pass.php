         ...
         <div class="section" id="detail-page">
            <div class="section-detail">
               <form method="POST" action="pages/change_pass_perform.php">
                  <label for="old-pass">username</label>
                  <input type="text" name="username" id="username" style="display: block;padding: 5px 10px;border: 1px solid #ddd;width: 35%;margin-bottom: 15px;" value="<?php echo $row["username"];?>" readonly><?php } ?>
