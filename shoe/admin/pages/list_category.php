<div id="main-content-wp" class="list-cat-page">
    ...
    <div class="wrap clearfix">
        <div id="sidebar" class="fl-left">
            <ul id="list-cat">
                <li>
                    <a href="?page=add_category" title="">Thêm mới danh mục</a>
                </li>
            </ul>
        </div>
                                    ...
                                    <td><span class="tbody-text"><?php echo $row["id"];?></h3></span>
                                        <td class="clearfix">
                                            ...
                                            <ul class="list-operation fl-right">
                                                <li><a href="?page=change_category&id=<?php echo $row['id'];?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                <li><a href="?page=delete_category&id=<?php echo $row['id'];?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                            </ul>
                                        </td>
                ...
                <div class="section-detail clearfix">
                    <ul id="list-paging" class="fl-right">
                        ...
                        <?php
                            ...
                            for($b=1;$b<=$sotrang;$b++){
                                echo '<li><a href="?page=list_category&trang='.$b.'" style="text-decoration:none">'.' '.$b.' '.'</a></li>';
                            }
                            ?>
                        <li>
                            <a href="" title="">></a>
